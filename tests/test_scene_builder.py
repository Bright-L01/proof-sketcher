...
from src.proof_sketcher.animator.models import (
    AnimationConfig, AnimationRequest, AnimationScene, 
...
class TestProofAnimationBuilder:
    ...
    def test_build_animation_request_with_segmentation(self, builder):
        ...
        config = AnimationConfig(
            step_duration=30.0,  # 30s per step
            max_duration=300.0   # 5 minute max
        )
    ...
    def test_create_introduction_segment_with_overview(self, builder):
        ...
        proof = ProofSketch(
            ...
            key_steps=[ProofStep(step_number=1, description="Step", mathematical_content="a=b")],
            conclusion="Done"
        )
    ...
    def test_group_proof_steps_with_logical_breaks(self, builder):
        ...
        steps = [
            ...
            ProofStep(step_number=4, description="Inductive step", mathematical_content=""),
        ...
        assert any("base case" in step.description.lower() 
                  for group in groups for step in group 
    ...
    def test_group_proof_steps_with_case_analysis(self, builder):
        ...
        steps = [
            ProofStep(step_number=1, description="Setup", mathematical_content="", tactics=[]),
            ProofStep(step_number=2, description="Case 1", mathematical_content="", tactics=["cases"]),
            ProofStep(step_number=3, description="Case 2", mathematical_content="", tactics=["by_cases"]),
        ]
    ...
    def test_is_logical_break_point(self, builder):
        ...
        break_steps = [
            ...
            ProofStep(step_number=2, description="Inductive step", mathematical_content=""),
            ProofStep(step_number=3, description="Suppose x > 0", mathematical_content=""),
            ProofStep(step_number=4, description="By contradiction", mathematical_content=""),
            ProofStep(step_number=5, description="Therefore, we have", mathematical_content=""),
        ]
        ...
        # Non-break step
        regular_step = ProofStep(step_number=1, description="Apply simplification", mathematical_content="")
    ...
    def test_contains_case_analysis(self, builder):
        ...
        case_steps = [
            ProofStep(step_number=1, description="", mathematical_content="", tactics=["cases"]),
            ProofStep(step_number=2, description="", mathematical_content="", tactics=["by_cases"]),
            ProofStep(step_number=3, description="", mathematical_content="", tactics=["split"]),
            ProofStep(step_number=4, description="", mathematical_content="", tactics=["left"]),
            ProofStep(step_number=5, description="", mathematical_content="", tactics=["right"]),
        ]
        ...
        # Non-case step
        regular_step = ProofStep(step_number=1, description="", mathematical_content="", tactics=["simp"])
    ...
    def test_get_segment_title(self, builder):
        ...
        # Single step
        single_group = [ProofStep(step_number=5, description="Single", mathematical_content="")]
        ...
        # Base case
        base_group = [
            ProofStep(step_number=1, description="Base case n=0", mathematical_content=""),
            ProofStep(step_number=2, description="Verify base", mathematical_content=""),
        ]
        assert builder._get_segment_title(base_group) == "Base Case"
        
        # Inductive step
        inductive_group = [
            ProofStep(step_number=3, description="Inductive hypothesis", mathematical_content=""),
            ProofStep(step_number=4, description="Prove inductive step", mathematical_content=""),
        ]
    ...
    def test_analyze_step_transformation(self, builder):
        ...
        with patch.object(builder.formula_extractor, 'analyze_proof_transformation', 
    ...
    def test_extract_step_formulas_with_formula_extractor(self, builder):
        ...
        with patch.object(builder.formula_extractor, 'extract_from_proof_step',
                         return_value=("a + b", "b + a")):
            with patch.object(builder.formula_extractor, 'convert_lean_to_latex',
