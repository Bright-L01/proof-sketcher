...
from proof_sketcher.parser.lean_parser import LeanParser, LeanParserError
from proof_sketcher.parser.config import ParserConfig, RetryConfig
from proof_sketcher.parser.models import ParseResult, TheoremInfo, ParseError
...
class TestLeanParserIntegration:
    ...
    def test_parser_initialization_default_config(self):
        ...
        assert parser.extractor_path.name == "lean_extractor.lean"
    ...
    def test_parse_file_with_lake_project(self, mock_run, tmp_path):
        ...
        lake_calls = [call for call in mock_run.call_args_list if any("lake" in str(arg) for arg in call[0])]
