...
class ErrorHandlingTester:
        ...
        test_results.append(
            {
                ...
                "passed": len(markdown_files)
                >= 4,  # At least 4 out of 5 should succeed
            ...
            test_results.append(
                {
                    ...
                    "passed": "File not found" in error_msg
                    and "/nonexistent/file.lean" in error_msg,
    ...
    def test_resource_limit_errors(self):
        ...
        from proof_sketcher.core.resource_limits import TimeoutError, timeout
    ...
    def _print_summary(self):
        ...
        assessments = {
            "Custom exception hierarchy": self._check_result(
            ...
            "Batch operation resilience": self._check_result(
