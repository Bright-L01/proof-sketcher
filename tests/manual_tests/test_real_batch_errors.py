...
def test_batch_export_with_failures():
    ...
    success_rate_md = len(actual_md_files) / expected_successes if expected_successes > 0 else 0
    success_rate_html = len(actual_html_files) / expected_successes if expected_successes > 0 else 0
