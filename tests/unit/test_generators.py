...
from proof_sketcher.generator.models import GenerationContext, ProofSketch, ProofStep
...
from proof_sketcher.generator.prompts.mathematical_context import (
    MathematicalContextPrompt,
)
...
class TestAIGenerator:
    ...
    @pytest.mark.asyncio
    async def test_generate_proof_sketch_basic(
        self, sample_theorem, generation_context
    ):
...
class TestGenerationContext:
    ...
    def test_context_creation(self):
        ...
        context = GenerationContext(model="claude-3", temperature=0.7, max_tokens=2000)
    ...
    def test_context_serialization(self):
        ...
        context = GenerationContext(model="claude-3", temperature=0.7, style="detailed")
    ...
    def test_context_merging(self):
        ...
        base_context = GenerationContext(model="claude-3", temperature=0.7)

        override_context = GenerationContext(temperature=0.5, max_tokens=1500)
