...
from proof_sketcher.core.exceptions import GenerationError  # Alias
from proof_sketcher.core.exceptions import (  # Base exceptions; Parser exceptions; Generator exceptions; Animator exceptions; Exporter exceptions; Configuration exceptions; Cache exceptions; Validation exceptions; Batch processing exceptions; Resource management exceptions; Error handling
    AIExecutableError,
    AITimeoutError,
...
class TestProofSketcherError:
    ...
    def test_all_parameters(self):
        ...
        error = ProofSketcherError(
            "Complete error", details=details, error_code="COMPLETE_001"
        )
...
class TestResourceManagementExceptions:
    ...
    def test_disk_space_error_with_sizes(self):
        ...
        error = DiskSpaceError(
            "Not enough space", required_space=required, available_space=available
        )
    ...
    def test_network_error_with_operation(self):
        ...
        error = NetworkError(
            "Connection timeout", operation="api_call", context=context
        )
    ...
    def test_handle_proof_sketcher_error(self):
        ...
        with patch.object(handler.logger, "error") as mock_error:
            ...
            mock_error.assert_called_once_with(
                "ProofSketcherError: [TEST_001] Test error"
            )
