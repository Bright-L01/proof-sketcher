...
class TestEndToEndPipeline:
    ...
    def test_parse_generate_export_ai(self, sample_lean_file, output_dir, mock_anthropic_client):
    ...
    def test_multiple_theorems_pipeline(self, complex_lean_file, output_dir):
        ...
        for i, sketch in enumerate(sketches):
            ...
            assert theorem_file is not None, f"No file found for theorem {sketch.theorem_name}"
...
class TestRegressionTests:
    ...
    def test_parser_handles_various_formats(self, temp_dir):
        ...
        for i, content in enumerate(test_cases):
            ...
            assert len(result.theorems) == 1, f"Expected 1 theorem, got {len(result.theorems)} for: {content}"
