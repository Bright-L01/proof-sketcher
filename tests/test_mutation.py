...
class MutationEngine:
                ...
                for operator in self.operators:
                    ...
                    if mutated:
                        ...
                        mutation = Mutation(
                            ...
                            mutated_code=ast.unparse(mutated) if hasattr(ast, 'unparse') else str(mutated),
    ...
    def run_mutation_testing(self, target_files: Optional[List[Path]] = None,
...
def run_mutation_analysis(target_module: str = "proof_sketcher.core.utils"):
    ...
    results = engine.run_mutation_testing(
        ...
        sample_rate=0.1  # Test 10% of mutations for speed
    )
