...
class TestIGeneratorAbstractClass:
    ...
    def test_abstract_methods(self):
        ...
        assert getattr(IGenerator.generate_eli5_explanation, '__isabstractmethod__', False)
    ...
    def test_method_signatures(self):
        ...
        class TestGenerator(IGenerator):
            def generate_proof_sketch(self, theorem, config=None, mathematical_context=None):
                ...
                assert mathematical_context is None or isinstance(mathematical_context, str)
                return MockProofSketch(theorem_name=theorem.name)
...
class TestIAnimatorProtocol:
    ...
    async def test_async_method_call(self):
        ...
        class TestAnimator:
            async def animate_proof(self, proof_sketch, config=None):
                return MockAnimationResponse(
                    video_path=Path(f"{proof_sketch.theorem_name}.mp4"),
                    success=True
                )
...
class TestInterfaceIntegration:
    ...
    def test_interface_type_checking(self):
        ...
        class ValidParser:
            def parse_file(self, file_path: Path): pass
            def parse_theorem(self, file_path: Path, theorem_name: str): pass
        
        class ValidGenerator(IGenerator):
            def generate_proof_sketch(self, theorem, config=None, mathematical_context=None): pass
            def generate_eli5_explanation(self, theorem, config=None): pass
