...
class TestJupyterExporterComprehensive:
    ...
    def test_notebook_structure_complete(self, exporter, sample_proof_sketch, tmp_path):
        ...
        assert len(cells) >= 6  # Title, intro, overview, interactive, animation/steps, conclusion
        ...
        cell_sources = [" ".join(cell["source"]) if isinstance(cell["source"], list) else cell["source"] for cell in cells]
    ...
    def test_code_cells_content(self, exporter, sample_proof_sketch, tmp_path):
        ...
        assert len(code_cells) >= 2  # Interactive exploration + step exploration + summary
    ...
    def test_export_multiple_sketches(self, exporter, sample_proof_sketch, simple_proof_sketch, tmp_path):
    ...
    def test_combined_notebook_structure(self, exporter, sample_proof_sketch, simple_proof_sketch, tmp_path):
    ...
    def test_context_with_custom_project_name(self, exporter, sample_proof_sketch, tmp_path):
    ...
    def test_export_preserves_step_order(self, exporter, tmp_path):
        ...
        sketch = ProofSketch(
            ...
            key_steps=[
                ProofStep(step_number=3, description="Third step", mathematical_content="3 = 3"),
                ProofStep(step_number=1, description="First step", mathematical_content="1 = 1"),
                ProofStep(step_number=2, description="Second step", mathematical_content="2 = 2"),
            ],
        ...
        for cell in markdown_cells:
            ...
            if "Step" in content and ("First" in content or "Second" in content or "Third" in content):
