...
from .models import ProofSketch
...
class ProgressiveGenerator:
    ...
    def generate_progressive_explanation(
        ...
        for level in [
            ...
            if isinstance(theorem, SemanticTheoremInfo):
                ...
                difficulty_scores.append(
                    self._estimate_basic_difficulty(theorem, level)
                )
        ...
        learning_pathway = self._generate_learning_pathway(
            theorem, levels, key_concepts
        )
        ...
        return ProgressiveSketch(
            ...
            mathematical_maturity_required=self._assess_maturity_requirements(
                theorem, levels
            ),
        )
    ...
    def _generate_intuitive_examples(
        ...
        if "+" in statement and any(
            word in statement.lower() for word in ["nat", "number"]
        ):
            examples.extend(
                [
    ...
    def _generate_exploration_suggestions(
        ...
        if "=" in statement:
            suggestions.append(
                "Try to come up with counterexamples (they won't work, but it's instructive)"
            )
    ...
    def _assess_maturity_requirements(
        ...
        if complexity < 2:
            requirements[EducationalLevel.BEGINNER] = (
                "Basic algebra and logical thinking"
            )
            requirements[EducationalLevel.INTERMEDIATE] = (
            ...
            requirements[EducationalLevel.ADVANCED] = (
                "Mathematical maturity and proof experience"
            )
        else:
            requirements[EducationalLevel.BEGINNER] = (
                "Calculus and mathematical maturity"
            )
            requirements[EducationalLevel.INTERMEDIATE] = (
    ...
    def _explain_induction_concept(self) -> ConceptExplanation:
        ...
        return ConceptExplanation(
            ...
            examples=[
                ...
                "Establishing properties of recursive definitions",
            ],
            common_misconceptions=[
                "Thinking you assume what you want to prove",
    ...
    def _explain_implication_concept(self) -> ConceptExplanation:
        ...
        return ConceptExplanation(
            ...
            common_misconceptions=[
                ...
                "Thinking the converse is always true",
            ],
            related_concepts=[
                "Contrapositive",
                "Converse",
    ...
    def _explain_natural_numbers(self) -> ConceptExplanation:
        ...
        return ConceptExplanation(
            ...
            common_misconceptions=[
                "Whether 0 is included varies by convention",
                "Thinking they're the same as integers",
            ],
    ...
    def _explain_real_numbers(self) -> ConceptExplanation:
        ...
        return ConceptExplanation(
            ...
            common_misconceptions=[
                "Thinking all reals are rational",
                "Confusing with complex numbers",
            ],
            related_concepts=[
                "Rational numbers",
                "Irrational numbers",
