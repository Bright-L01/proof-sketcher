...
from ..parser.lsp_client import SemanticTheoremInfo, TacticInfo, ProofState
...
class SemanticGenerator:
    ...
    def generate_educational_sketch(
        ...
        """
        self.logger.info(f"Generating educational sketch for {theorem.name} at {target_level} level")
    ...
    def generate_proof_sketch(
        self, theorem: Union[SemanticTheoremInfo, TheoremInfo], config: Optional[GenerationConfig] = None
    ) -> ProofSketch:
        ...
        """
        return self.generate_educational_sketch(theorem, EducationalLevel.INTERMEDIATE, config)
        
    def generate_offline(self, theorem: Union[SemanticTheoremInfo, TheoremInfo]) -> ProofSketch:
        ...
        Returns:
            Generated proof sketch
        """
        return self.generate_educational_sketch(theorem, EducationalLevel.INTERMEDIATE, None)
    ...
    def _generate_semantic_sketch(
        ...
        introduction = self._generate_level_introduction(theorem, target_level, edu_profile)
        ...
        conclusion = self._generate_educational_conclusion(theorem, target_level, edu_profile)
    ...
    def _generate_basic_introduction(self, theorem: TheoremInfo, target_level: str) -> str:
    ...
    def _generate_basic_steps(self, theorem: TheoremInfo, target_level: str) -> List[ProofStep]:
    ...
    def _generate_basic_conclusion(self, theorem: TheoremInfo, target_level: str) -> str:
        ...
        if target_level == EducationalLevel.BEGINNER:
            ...
            conclusion += "This formally establishes the stated mathematical relationship."
    ...
    def _get_basic_setup_intuition(self, target_level: str) -> str:
        ...
        if target_level == EducationalLevel.BEGINNER:
            return "We start by understanding what we're trying to prove and what we know."
        elif target_level == EducationalLevel.INTERMEDIATE:
    ...
    def _get_basic_induction_intuition(self, target_level: str) -> str:
        ...
        if target_level == EducationalLevel.BEGINNER:
            ...
            return "We utilize the induction principle of the underlying inductive type."
    ...
    def _get_basic_reasoning_intuition(self, target_level: str) -> str:
        ...
        if target_level == EducationalLevel.BEGINNER:
            ...
            return "We apply appropriate mathematical techniques to establish the result."
        else:
            return "We employ the relevant proof-theoretic methods for this type of statement."
        
    def _analyze_educational_profile(self, theorem: SemanticTheoremInfo) -> Dict[str, any]:
        ...
        return {
            ...
            "has_induction": any(t.name == "induction" for t in theorem.tactic_sequence),
            "has_cases": any(t.name == "cases" for t in theorem.tactic_sequence),
            "is_computational": theorem.proof_method in ["simplification", "rewriting", "calculation"],
    ...
    def _generate_level_introduction(
        ...
        if target_level == EducationalLevel.BEGINNER:
            return self._generate_beginner_introduction(theorem, edu_profile, base_intro)
        elif target_level == EducationalLevel.INTERMEDIATE:
            return self._generate_intermediate_introduction(theorem, edu_profile, base_intro)
        else:  # Advanced
            return self._generate_advanced_introduction(theorem, edu_profile, base_intro)
    ...
    def _generate_beginner_introduction(
        ...
        if "=" in statement:
            ...
            intro += "It proves something is true for all possible cases we might consider. "
    ...
    def _generate_intermediate_introduction(
        ...
        method = edu_profile.get("proof_method", "unknown")
        method_explanation = self.proof_method_explanations.get(method, {}).get("intermediate", "")
        ...
        if complexity < 2:
            intro += "The proof is relatively direct, using basic mathematical principles. "
        elif complexity < 4:
    ...
    def _generate_advanced_introduction(
        ...
        if method == "induction":
            ...
            intro += "The proof primarily uses equational reasoning and term rewriting. "
    ...
    def _generate_progressive_steps(
        ...
        if theorem.tactic_sequence:
            ...
            return self._generate_generic_educational_steps(theorem, target_level, edu_profile)
    ...
    def _group_tactics_educationally(self, tactics: List[TacticInfo]) -> List[List[TacticInfo]]:
    ...
    def _create_educational_step(
        ...
        intuition = level_info.get("intuition", f"This step uses {main_tactic.name} to make progress.")
        
        # Enhance with context
        if target_level == EducationalLevel.BEGINNER:
            intuition = self._enhance_intuition_for_beginners(intuition, main_tactic, edu_profile)
        elif target_level == EducationalLevel.ADVANCED:
            description = self._enhance_description_for_advanced(description, main_tactic, edu_profile)
    ...
    def _get_setup_intuition(self, target_level: str, edu_profile: Dict[str, any]) -> str:
    ...
    def _get_main_reasoning_intuition(self, target_level: str, edu_profile: Dict[str, any]) -> str:
    ...
    def _get_conclusion_intuition(self, target_level: str, edu_profile: Dict[str, any]) -> str:
    ...
    def _generate_educational_conclusion(
        ...
        if target_level == EducationalLevel.BEGINNER:
            ...
            return self._generate_advanced_conclusion(base_conclusion, edu_profile, theorem)
            
    def _generate_beginner_conclusion(self, base: str, edu_profile: Dict[str, any]) -> str:
    ...
    def _generate_intermediate_conclusion(self, base: str, edu_profile: Dict[str, any]) -> str:
        ...
        method = edu_profile.get("proof_method", "unknown")
        method_context = self.proof_method_explanations.get(method, {}).get("significance", "")
        if method_context:
