...
from typing import TYPE_CHECKING, Protocol, Optional, List, Dict, Any, runtime_checkable

from pydantic import BaseModel

if TYPE_CHECKING:
    from ..parser.models import TheoremInfo
    from ..generator.models import ProofSketch, GenerationConfig
...
class IParser(Protocol):
    ...
    def parse_theorem(self, file_path: Path, theorem_name: str) -> Optional["TheoremInfo"]:
