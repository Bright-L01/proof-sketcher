...
class SmartCache:
    ...
    def generate_key(self, theorem: Union[TheoremInfo, Dict], operation: str = "sketch") -> str:
    ...
    def generate_export_key(self, sketch: ProofSketch, format_name: str, options: Dict = None) -> str:
        """Generate cache key for export operations."""
        data = {
            'theorem_name': sketch.theorem_name,
            'introduction_hash': hashlib.sha256(sketch.introduction.encode()).hexdigest()[:16],
