...
class CacheManager:
    ...
    def get_cache_key(
        self, file_path: str, theorem_name: str, content: str, version: str = "1.0"
    ) -> str:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            for entry in self.index.values():
                ...
                category_sizes[category] = category_sizes.get(category, 0) + entry.get(
                    "size", 0
                )
    ...
    def export_cache_info(self, output_file: Path) -> None:
        ...
        """
        with self._lock:
            info = {"statistics": self.get_statistics(), "entries": []}
