...
class InputSanitizer:
    ...
    DANGEROUS_TAGS = {
        ...
        'style', 'base', 'applet', 'bgsound', 'frame', 'frameset'
    }
    ...
    def sanitize_html(text: str, allow_basic_tags: bool = False) -> str:
        ...
        text = re.sub(r'(href|src)\s*=\s*["\']?(javascript|data|vbscript):[^"\']*["\']?', '', text, flags=re.IGNORECASE)
    ...
    def sanitize_filename(filename: str) -> str:
        ...
        if len(filename) > InputSanitizer.MAX_NAME_LENGTH:
            ...
            max_name_len = InputSanitizer.MAX_NAME_LENGTH - len(ext) - 1 if ext else InputSanitizer.MAX_NAME_LENGTH
    ...
    @staticmethod
    def sanitize_json_input(data: Any, max_depth: int = 10, current_depth: int = 0) -> Any:
        """
    ...
    def sanitize_latex(latex: str) -> str:
        ...
        dangerous_commands = [
            r'\\input', r'\\include', r'\\write', r'\\read', r'\\openin',
            r'\\openout', r'\\immediate', r'\\special', r'\\csname',
            r'\\expandafter', r'\\catcode', r'\\def', r'\\gdef',
            r'\\edef', r'\\xdef', r'\\let', r'\\futurelet'
        ]
