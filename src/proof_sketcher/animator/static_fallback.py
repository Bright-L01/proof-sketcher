...
class StaticVisualizer:
    ...
    def __init__(self):
        ...
        if not MATPLOTLIB_AVAILABLE:
            self.logger.warning("Matplotlib not available - static visualizations disabled")
    ...
    def _draw_statement(self, ax: Any, theorem: Dict[str, Any]) -> None:
        ...
        # Statement text
        ax.text(
            5, 7.5 - statement_height/2, wrapped_statement,
    ...
    def _draw_proof_steps(self, ax: Any, sketch: Dict[str, Any]) -> None:
        ...
        if not steps:
            ...
            ax.text(
                5, 4.5, "Proof steps not available",
        ...
        for i, step in enumerate(steps[:max_steps]):
            ...
            step_box = FancyBboxPatch(
                (1.8, y_pos - step_height/2), 7.7, step_height,
            ...
            if i < max_steps - 1 and i < len(steps) - 1:
                ...
                ax.annotate(
                    '', xy=(1.2, arrow_y - 0.1), xytext=(1.2, arrow_y + 0.1),
                    arrowprops=dict(
                        arrowstyle='->', 
        ...
        if len(steps) > max_steps:
            ...
            ax.text(
                5, start_y - max_steps * (step_height + step_spacing) - 0.3,
