...
def run_quick_benchmark():
        ...
        for size in test_sizes:
            ...
            for theorem in parse_result.theorems:
                try:
                    ...
                    console.print(f"  [red]Error generating sketch for {theorem.name}: {e}[/red]")
            ...
            console.print(f"  ✓ Processed {actual_count} theorems in {total_time:.0f}ms ({rate:.1f} thm/s)")
    ...
    if results:
        ...
        if avg_rate > 10:
            console.print("  ✅ [green]Excellent performance - ready for large files[/green]")
        elif avg_rate > 5:
            console.print("  ✅ [green]Good performance - suitable for medium files[/green]")
        elif avg_rate > 1:
            console.print("  ⚠️ [yellow]Moderate performance - may be slow on large files[/yellow]")
        else:
        ...
        if max_errors == 0:
            ...
            console.print(f"  ⚠️ [yellow]Found {max_errors} parsing errors - check file format[/yellow]")
