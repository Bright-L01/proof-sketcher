...
def test_generator_functionality():
    ...
    assert sketch.theorem_statement == "∀ (n : Nat), n + 0 = n", "Statement should match"
    ...
    assert ai_sketch.theorem_statement == "∀ (n : Nat), n + 0 = n", "AI statement should match"
...
''')
    ...
    try:
        ...
        assert sketch.theorem_statement == theorem.statement, "Statement should be preserved"
...
def test_regression_empty_statements():
    ...
    try:
        ...
        generator = OfflineGenerator()
        sketch = generator.generate_proof_sketch(theorem)
        assert sketch.theorem_statement == theorem.statement, "Statement must be preserved"
